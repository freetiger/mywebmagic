...
public class ZhihuRegisterProcessor implements PageProcessor {
...
//    	pipelines.add(new ConsolePipeline());
        Spider.create(new ZhihuRegisterProcessor()).addUrl("http://v2ex.com/t/118361").setPipelines(pipelines).thread(1).run();
    }
